package com.lucasdonato.pokemon_api.mechanism.search_bar
...
class SearchViewAnimation(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.include_search_bar, this, true)
